<nav id="page-leftbar" role="navigation">
    <div>
      <ul style="top: 40px;" class="ng-scope" ng-controller="NavigationController" id="sidebar" sticky-scroll="40">
		...
		<li class="ng-scope"><a href="index.php?view=attendance" class="ng-scope">
          <i ng-if="item.iconClasses" class="fa fa-blog"></i>
          <span class="ng-binding">Attendance</span></a>
        </li>
		<li class="ng-scope"><a href="index.php?view=leavemanager" class="ng-scope">
          <i ng-if="item.iconClasses" class="fa fa-blog"></i>
          <span class="ng-binding">Leave Manager</span></a>
        </li>
        ...
        <li class="ng-scope"><a href="index.php?view=enquiry" class="ng-scope">
          <i ng-if="item.iconClasses" class="fa fa-blog"></i>
          <span class="ng-binding">Enquiry</span></a>
        </li>
		
        <li class="ng-scope"><a href="index.php?view=ticket" class="ng-scope">
          <i ng-if="item.iconClasses" class="fa fa-blog"></i>
          <span class="ng-binding">Tickets</span></a>
        </li>
		<li class="ng-scope"><a href="index.php?view=company" class="ng-scope">
          <i ng-if="item.iconClasses" class="fa fa-blog"></i>
          <span class="ng-binding">Companies</span></a>
        </li>
        <li class="ng-scope"><a href="index.php?view=project" class="ng-scope">
          <i ng-if="item.iconClasses" class="fa fa-blog"></i>
          <span class="ng-binding">Projects</span></a>
        </li>
		
        <li class="ng-scope"><a href="index.php?view=ourworks" class="ng-scope">
          <i ng-if="item.iconClasses" class="fa fa-blog"></i>
          <span class="ng-binding">Our Works</span></a>
        </li>
