...
$template->includejs("https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js",1,0,1);
if($my->uid >0)
 {
	...
	$template->includejs("templates/itcslive/js/colorbox/jquery.colorbox.js",2,0);
	$template->includejs("templates/itcslive/js/auto_jqueryui/kendo.all.min.js",3,0);
	$template->includejs("classes/external/editor/tinymce.min.js",4,0);
}
?>
<!DOCTYPE html>
<html>
