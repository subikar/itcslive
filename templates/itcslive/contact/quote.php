...
<form action="" method="post" class="form-horizontal getofferForm" name="GetFreeQuote" id="GetFreeQuote" target="_parent">
        ...
        <div id="contact_form" class="pop-form">
         <div class="head-bg">Get A Free Quote</div>
          <div class="extra-padding">
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<div class="input-icon">
                <input name="city" id="city-16543" title="City" value="" class="required-entry validate_me span12 city-input ui-autocomplete-input" type="text" autocomplete="off">
				<span style="display: none;" class="error error-empty">*This is not a valid email address.</span>
				<span style="display: none;" id="error_city" class="empty error-empty">*This field is required.</span> </label>
