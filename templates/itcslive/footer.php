...
<aside>
  ...
  <div class="main-footer">
    <div class="container_12">
			...
			<div class="grid_2">
			<h2 class="bot-6 foot">Follow us</h3>
			<table align="center">
			  <tbody>
				<tr>
				  <td class="social_icons"><a target="_blank" href="https://www.facebook.com/itcslive"><i class="fa fa-fw fa-facebook-square"></i></a></td>
				  <td class="social_icons"><a target="_blank" href="https://www.youtube.com/user/iTCSLIVE?feature=mhee"><i class="fa fa-fw fa-youtube-square"></i></a></td>
				  <td class="social_icons"><a target="_blank" href="https://twitter.com/outsourcing_web"><i class="fa fa-fw fa-twitter-square"></i></a></td>
				  <td class="social_icons"><a target="_blank" href="https://plus.google.com/101459946125679381605/posts"><i class="fa fa-fw fa-google-plus-square"></i></a></td>
				</tr>
			  </tbody>
			</table>			
			</div>
